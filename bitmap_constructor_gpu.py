...
if __name__ == '__main__':
	...
	produce_chId_lit_gpu[1,tpb](d_rid, d_literal, d_chunk_id)
	...
	fill_word = produce_fill(reduced_input_data, reduced_chunk_id, reduced_length)
	...
	out_index = getIdx(fill_word,reduced_literal, reduced_length)
